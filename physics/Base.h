...
struct BaseVehicleParams
{
	...
	//Command response
	PxVehicleBrakeCommandResponseParams brakeResponseParams[2]; // 0 = front, 1 = rear 刹车
	PxVehicleSteerCommandResponseParams steerResponseParams; // 转向
	PxVehicleAckermannParams ackermannParams[1]; // 0 = front 代表阿克曼转向

	//Suspension
	PxVehicleSuspensionParams suspensionParams[PxVehicleLimits::eMAX_NB_WHEELS]; //悬挂
	PxVehicleSuspensionComplianceParams suspensionComplianceParams[PxVehicleLimits::eMAX_NB_WHEELS]; // 悬挂刚度
	PxVehicleSuspensionForceParams suspensionForceParams[PxVehicleLimits::eMAX_NB_WHEELS]; // 悬挂力

	//Tires
	PxVehicleTireForceParams tireForceParams[PxVehicleLimits::eMAX_NB_WHEELS]; // 轮胎力

	//Wheels
	PxVehicleWheelParams wheelParams[PxVehicleLimits::eMAX_NB_WHEELS]; // 车轮参数

	//Rigid body
	PxVehicleRigidBodyParams rigidBodyParams; // 刚体参数

	// 根据源和目标变换和缩放，返回一个新的BaseVehicleParams
...
#endif // #ifndef PX_PHYSICS_VEHICLE_BASE_H